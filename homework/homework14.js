...
/*Write a function named convertTemperature() which takes a number and a string 
arguments to be considered as a temperature value and a unit (either Celsius or Fahrenheit) 
...
const sumOfEvenNumbers = (arr) => arr.reduce((sum, n) => n % 2 === 0 ? sum = sum + n : sum , 0)
...
const capsOdds = (arr) => arr.map((word, i) => i % 2 !== 0 ? word.toUpperCase() : word)
